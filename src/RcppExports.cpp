...
// createNullEvents
DataFrame createNullEvents(std::vector<std::string> eventID, std::vector<std::string> sender, std::vector<std::string> target, std::vector<std::string> eventAttribute, std::vector<double> time, std::vector<double> start, std::vector<double> end, std::vector<double> allEventTimes, double nrows);
RcppExport SEXP _rem_createNullEvents(SEXP eventIDSEXP, SEXP senderSEXP, SEXP targetSEXP, SEXP eventAttributeSEXP, SEXP timeSEXP, SEXP startSEXP, SEXP endSEXP, SEXP allEventTimesSEXP, SEXP nrowsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< double >::type nrows(nrowsSEXP);
    rcpp_result_gen = Rcpp::wrap(createNullEvents(eventID, sender, target, eventAttribute, time, start, end, allEventTimes, nrows));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rem_createNullEvents", (DL_FUNC) &_rem_createNullEvents, 9},
